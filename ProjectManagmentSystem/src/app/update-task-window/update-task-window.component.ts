...
@Component({
  selector: 'app-update-task-window',
  templateUrl: './update-task-window.component.html',
  styleUrls: ['./update-task-window.component.css']
})
export class UpdateTaskWindowComponent implements OnInit {
  submitted = false;
